...
int main()
{
	...
	//std::fstream fs("C:/Users/Random-Typ/source/repos/RMonitor - Server Monitor/RMonitor PluginsDB/example-db/pluginsDB.json");
	...
	RJSON::RJSONStream j;
	RJSON::JSONElement json = j.parseStream("C:/Users/Random-Typ/source/repos/RMonitor - Server Monitor/RMonitor PluginsDB/example-db/pluginsDB.json");
